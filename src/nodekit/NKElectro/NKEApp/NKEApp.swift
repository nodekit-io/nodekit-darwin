...
extension NKE_App: NKScriptExport {
    ...
    func rewriteGeneratedStub(stub: String, forKey: String) -> String {
        ...
        case ".global":
            ...
            return NKStorage.getPluginWithStub(stub, "lib-electro.nkar/lib-electro/app.js", NKElectro.self)
...
class NKE_App: NSObject, NKEAppProtocol {
    ...
    func getAppPath() -> String { return (NKStorage.mainBundle.bundlePath as NSString).stringByDeletingLastPathComponent }
